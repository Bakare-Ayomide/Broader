...
export const NIGERIAN_DRIVERS_POOL: (Driver & {
  ...
  },
  {
    ...
    car_image_url: VEHICLE_3D_ASSETS.tricycle,
    car_seats: 3,
    rating: 4.82,
  ...
  },
  {
    ...
    title: 'Emeka Nwosu',
    profile_image_url: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=180&auto=format&fit=crop&q=80',
    car_image_url: VEHICLE_3D_ASSETS.van,
    car_seats: 10,
    rating: 4.89,
  ...
  },
  {
    ...
    car_image_url: VEHICLE_3D_ASSETS.pickup,
    car_seats: 3,
    rating: 4.91,
...
export const fetchBackendVehiclePricing = async (
  ...
  const vehicleConfigs: {
    ...
    },
    {
      ...
      minFare: 6800,
      etaMultiplier: 1.3,
      description: 'Spacious passenger van for group journeys & luggage',
      iconName: 'Users',
    },
    {
      category: 'bus',
      ...
      minFare: 14500,
      etaMultiplier: 1.5,
      description: 'High-capacity shuttle bus for teams & large groups',
      iconName: 'Bus',
    },
    {
      category: 'bicycle',
      ...
      minFare: 650,
      etaMultiplier: 0.8,
      description: 'Zero-emission commuter bicycle for short hops',
      iconName: 'Bike',
    },
    {
      category: 'deliveryBike',
      name: 'Delivery Bike',
      capacity: 'Up to 35kg parcel box',
      baseFare: 800,
      perKmRate: 160,
      minFare: 1200,
      etaMultiplier: 0.65,
      description: 'High-speed urban courier dispatch motorcycle',
      iconName: 'Package',
    },
    {
      category: 'tricycle',
    ...
    },
    {
      ...
      minFare: 22000,
      etaMultiplier: 1.8,
      description: 'Heavy duty commercial transport lorry for cargo & freight',
      iconName: 'Truck',
    },
    {
      category: 'ambulance',
      name: 'Ambulance',
      capacity: 'Paramedic + Patient',
      baseFare: 25000,
      perKmRate: 1200,
      minFare: 15000,
      etaMultiplier: 0.5,
      description: 'Emergency response transit with paramedic equipment',
      iconName: 'HeartPulse',
    },
  ];
...
export const BROADER_RENTAL_FLEET = [
  {
    ...
    hasAC: true,
    luggageCapacity: 5,
    imageUrl: VEHICLE_3D_ASSETS.suv,
    rating: 4.96,
    tripsCount: 142,
  ...
  },
  {
    ...
    hasAC: true,
    luggageCapacity: 3,
    imageUrl: VEHICLE_3D_ASSETS.car,
    rating: 4.98,
    tripsCount: 89,
  ...
  },
  {
    ...
    hasAC: true,
    luggageCapacity: 10,
    imageUrl: VEHICLE_3D_ASSETS.van,
    rating: 4.84,
    tripsCount: 167,
  ...
  },
  {
    ...
    hasAC: true,
    luggageCapacity: 8,
    imageUrl: VEHICLE_3D_ASSETS.pickup,
    rating: 4.92,
    tripsCount: 104,
