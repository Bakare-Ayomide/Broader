...
export const fetchBackendVehiclePricing = async (
  ...
  const vehicleConfigs: {
    ...
    {
      category: 'dispatch',
      name: 'Broader Dispatch Rider',
      capacity: 'Up to 35kg parcel box',
      baseFare: 800,
      perKmRate: 160,
      minFare: 1200,
      etaMultiplier: 0.65,
      description: 'High-speed urban courier dispatch with topbox storage',
      iconName: 'Package',
    },
    {
      category: 'ambulance',
      name: 'Emergency Ambulance',
      capacity: 'Paramedic + Patient + 1 Relative',
      baseFare: 25000,
      perKmRate: 1200,
      minFare: 30000,
      etaMultiplier: 0.5,
      description: 'Rapid life-support transit with verified emergency dispatch',
      iconName: 'HeartPulse',
    },
  ];
